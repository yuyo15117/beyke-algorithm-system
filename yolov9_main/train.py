...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='E:\\new_tooth_dataset\invisalign\shangxiahe_high_res\decay\yolov9-c.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='E:\yolov9-main\models\detect\yolov9-c.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='E:\yolov9-main\data\data.yaml', help='dataset.yaml path')
